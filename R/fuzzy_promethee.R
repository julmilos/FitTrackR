#' @title Metoda Fuzzy PROMETHEE II
#' @description Implementuje metodę PROMETHEE II dla wielokryterialnej analizy decyzyjnej w środowisku rozmytym.
#'
#' @param decision_matrix Macierz (m × 3n) lub trójkątne liczby rozmyte (TFN).
#' @param criteria_type Wektor ("max" / "min") dla każdego kryterium.
#' @param preference_params Parametry funkcji preferencji.
